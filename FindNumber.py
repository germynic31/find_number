...
if valid:
    ...
    time.sleep(3)
    print("Национальный номер: " + phonenumbers.format_number(parsed_phone, phonenumbers.PhoneNumberFormat.NATIONAL))
    time.sleep(0.5)
    print("Регистрация номера: " + geocoder.country_name_for_number(parsed_phone, 'ru'), geocoder.description_for_number(parsed_phone, 'ru'), sep=', ')
    time.sleep(0.5)
